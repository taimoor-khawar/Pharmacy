...
CREATE TABLE [dbo].[POS_TBLSUPPLIERS](
	[SUP_ID] [numeric](5, 0) IDENTITY(1,1) NOT NULL,
	[ENTERPRISEID] [numeric](8, 0) NOT NULL,
...
CREATE TABLE [dbo].[POS_TBLPRODUCTTYPE](
	[PT_ID] [numeric](5, 0) IDENTITY(1,1) NOT NULL,
	[ENTERPRISEID] [numeric](8, 0) NOT NULL,
...
CREATE TABLE [dbo].[POS_TBLPRODUCTS](
	[PR_ID] [numeric](5, 0) IDENTITY(1,1) NOT NULL,
	[ENTERPRISEID] [numeric](8, 0) NOT NULL,
	...
	[PR_SUPPLYPRICE] [float] NOT NULL,
	[PR_PROQUANTITY] [float] NOT NULL,
	[PR_MARKUP] [float] NOT NULL,
	[PR_RETAILPRICE] [float]NOT NULL,
