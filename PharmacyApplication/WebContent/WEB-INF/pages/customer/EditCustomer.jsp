					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								...
								<form name="customeredit" role="form" method="post" action="/POS/customer/edit" style="padding: 10px 10px">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										<label>Address 1</label> <textarea class="form-control" name="Address1" id="Address1" rows="10" cols="10"><%=customer.getAddress1()%></textarea> 
									</div>
									<div class="col-lg-6">
										<label>Address 2</label> <textarea class="form-control" name="Address2" id="Address2" rows="10" cols="10"><%=customer.getAddress2()%></textarea> 
									</div>
									<div class="col-lg-6">
