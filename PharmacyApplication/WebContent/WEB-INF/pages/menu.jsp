                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                         ...
                         <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/POS/order/orderlist?EnterprisedID=<%=us.getSysuser().getsysUserID()%>"> <i class="fa fa-table fa-fw"></i> Sale</a>
                                </li>
                                <li>
                                    <a href="/POS/order/purhaselist?EnterprisedID=<%=us.getSysuser().getsysUserID()%>"> <i class="fa fa-table fa-fw"></i> Purchase</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                       <%--  <li>
                         ...
                         <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i> Reporting<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="/POS/report/orderbycustomer?EnterprisedID=<%=us.getSysuser().getsysUserID()%>"> <i class="glyphicon glyphicon-th-list fa-fw"></i> Order Report (Customer)</a>
                                </li>
