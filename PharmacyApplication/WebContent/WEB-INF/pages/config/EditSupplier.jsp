...
<body>
	<div id="wrapper">
		...
		<div id="page-wrapper">
			<div class="row">
				<div class="col-lg-12">
					<h4 class="page-header">Edit Supplier</h4>
				</div>
				<!-- /.col-lg-12 -->
			</div>
			<!-- /.row -->
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								...
								<form name="supplieredit" role="form" method="post" action="/POS/config/supplier/editsupplier" style="padding: 10px 10px">
									<div class="col-lg-6">
										<label>First Name</label> <input class="form-control" type="text" value="<%=supplier.getFirstName() %>"
									...
									<input type="hidden" name="SupplierID" id="SupplierID" value="<%=supplier.getSupplierID()%>">
									<div class="col-lg-6">
										<label>Last Name</label> <input type="text" value="<%=supplier.getFirstName() %>"
											class="form-control" placeholder="Enter Last Name" name="LastName" id="LastName">
									</div>
									<div class="col-lg-6">
										<label>Email</label> <input class="form-control" type="email" value="<%=supplier.getEmail() %>"
											name="Email" id="Email" placeholder="Enter Email">
									</div>
									<div class="col-lg-6">
										<label>Phone Number</label> <input type="text" value="<%=supplier.getPhoneNumber() %>"
											class="form-control" placeholder="Enter Phone Number" name="PhoneNumber" id="PhoneNumber">
									</div>
									<div class="col-lg-6">
										<label>Address 1</label> <textarea class="form-control" name="Address1" id="Address1" rows="10" cols="10"><%=supplier.getAddress1()%></textarea> 
									</div>
									<div class="col-lg-6">
										<label>Address 2</label> <textarea class="form-control" name="Address2" id="Address2" rows="10" cols="10"><%=supplier.getAddress2()%></textarea> 
									</div>
									<div class="col-lg-6">
										<label>State/Province</label> <input class="form-control" type="text" value="<%=supplier.getState() %>"
											name="State" id="State" placeholder="Enter State">
									</div>
									<div class="col-lg-6">
										<label>Zip</label> <input type="text" value="<%=supplier.getZip() %>"
											class="form-control" placeholder="Enter Zip" name="Zip" id="Zip">
									</div>
									<div class="col-lg-6">
										<label>Country</label> <input class="form-control" type="text" value="<%=supplier.getCountry() %>"
											name="Country" id="Country" placeholder="Enter Country">
									</div>
									<div class="col-lg-6">
										<label>Code</label> <input type="text" value="<%=supplier.getCode() %>"
											class="form-control" placeholder="Enter Comments" name="Code" id="Code">
									</div>
