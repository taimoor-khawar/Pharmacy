					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="row">
								...
								<form name="producttypeeedit" role="form" method="post" action="/POS/config/producttype/editproducttype" style="padding: 10px 10px">
									<div class="col-lg-6">
										<label>Type Name</label> <input class="form-control" type="text" value="<%=pt.getProductTypeName() %>"
											name="ProductTypeName" id="ProductTypeName" placeholder="Enter Product Type">
									</div>
									<input type="hidden" name="EnterprisedID" id="EnterprisedID" value="<%=pt.getEnterprisedID()%>">
								    <input type="hidden" name="ProductTypeID" id="ProductTypeID" value="<%=pt.getProductTypeID()%>">
