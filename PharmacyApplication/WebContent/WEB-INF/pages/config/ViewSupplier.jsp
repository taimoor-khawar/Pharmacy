						...
						<div class="panel-body">
							<div class="row">
								...
								<form name="customeredit" role="form" method="post" action="/POS/customer/list" style="padding: 10px 10px">
									...
									<input type="hidden" name="CustomerID" id="CustomerID" value="<%=supplier.getSupplierID()%>">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										<label>Address 1</label> <textarea class="form-control" name="Address1" id="Address1" rows="10" cols="10" disabled="disabled"><%=supplier.getAddress1()%></textarea> 
									</div>
									<div class="col-lg-6">
										<label>Address 2</label> <textarea class="form-control" name="Address2" id="Address2" rows="10" cols="10" disabled="disabled"><%=supplier.getAddress2()%></textarea> 
									</div>
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										<label>Code</label> <input type="text" value="<%=supplier.getCode()%>"
											class="form-control" placeholder="Enter Comments" name="Code" id="Code" disabled="disabled">
									</div>
