						...
						<div class="panel-body">
							<div class="row">
								...
								<form name="productedit" id="productedit" role="form"
									method="post" action="/POS/product/addproduct" style="padding: 20px 20px">
									<div class="col-lg-6">
									...
									<div class="col-lg-6">
										<label>Product Code</label> <input type="text"
											...
											name="ProductCode" id="ProductCode" onchange="checkproductcode()"> <label
									...
									<div class="col-lg-6">
										<label>Supplier</label> <select name="SupplierID"
											...
											<option value="<%=sup.getSupplierID()%>"><%=sup.getCode()%>-<%=sup.getFirstName()%></option>
											<%} %>
										</select>
									</div>
